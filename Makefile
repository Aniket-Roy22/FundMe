...
deploy:
	@forge script script/FundMeDeploy.s.sol:FundMeDeploy $(NETWORK_ARGS)
...
fund:
	@forge script script/Interactions.s.sol:FundingFundMe --sender $(SENDER_ADDRESS) $(NETWORK_ARGS)

withdraw:
	@forge script script/Interactions.s.sol:WithdrawingFundMe --sender $(SENDER_ADDRESS) $(NETWORK_ARGS)